...
쪼렙 개미에서 만렙 개미로 성장하세요 👇"""
    ...
    # 도움말 카드 (카카오 캐러셀 basicCard)
    # 긴 simpleText는 카카오에서 잘리므로, 기능 카테고리별 카드로 분리한다.
    # 각 카드의 버튼은 해당 기능으로 바로 진입시켜 사용 흐름이 끊기지 않게 한다.
    # description은 단말 잘림 방지를 위해 카드당 약 200자 이내로 유지한다.
    HELP_CARDS = [
        {
            "title": "🐜 만렙개미 시작하기",
            "description": (
                "실제 한국 주식 시세로 투자하며 골드를 모아\n"
                "쪼렙 개미에서 만렙 개미로 성장하는 게임!\n"
                "출석·보물상자로 골드를 모으고, 각성으로\n"
                "레벨을 올려 보상을 키워보세요.\n"
                "👉 카드를 옆으로 넘겨 기능을 확인하세요."
            ),
            "buttons": [
                {"label": "🚀 시작하기", "messageText": "/시작"},
                {"label": "📅 출석", "messageText": "/출석"},
                {"label": "📈 급등주", "messageText": "/급등"},
            ],
        },
        {
            "title": "📊 주식 투자",
            ...
            "buttons": [
                {"label": "📈 급등주", "messageText": "/급등"},
                {"label": "🔍 시세 조회", "messageText": "/시세 삼성전자"},
                {"label": "💼 내 자산", "messageText": "/포트폴리오"},
            ],
        },
        {
            "title": "💼 내 자산",
            ...
            "buttons": [
                {"label": "💼 포트폴리오", "messageText": "/포트폴리오"},
                {"label": "🏆 랭킹", "messageText": "/랭킹"},
                {"label": "📊 주식 투자", "messageText": "/급등"},
            ],
        },
        {
            "title": "🎁 보상 · 🧬 각성",
            "description": (
                ...
                "/보물상자 — 하루 최대 5회 무료\n"
                "/각성 — 골드로 레벨업 도전\n"
                "  └ Lv.10 직군 배정 (트레이더·투자가·퀀트)\n"
                "/능력 — 내 각성·직군·보너스 확인\n"
                "⚠️ 각성은 장 마감 후에만 가능"
            ),
            "buttons": [
                {"label": "📅 출석", "messageText": "/출석"},
                {"label": "🎁 보물상자", "messageText": "/보물상자"},
                {"label": "🧬 각성", "messageText": "/각성"},
            ],
        },
        {
            "title": "🎮 예측 게임",
            "description": (
                "/시장예측 [금액] — 과거 주가 예언 (맞추면 2배!)\n"
                "/업다운 [금액] — 숫자 연속 맞추기, 연승 배율 UP\n"
                "⚠️ 예측 게임은 장 마감 후에만 가능"
            ),
            "buttons": [
                {"label": "🎮 시장예측", "messageText": "/시장예측"},
                {"label": "🔢 업다운", "messageText": "/업다운"},
                {"label": "🎁 보물상자", "messageText": "/보물상자"},
            ],
        },
        {
            ...
            "buttons": [
                {"label": "⚔️ 배틀", "messageText": "/배틀"},
                {"label": "🎯 미션", "messageText": "/미션"},
                {"label": "🏅 챌린지", "messageText": "/챌린지"},
            ],
        },
    ]
