...
class EnhanceConfig:
    ...
    CLASS_INFO = {
        1: {"name": "국장파", "emoji": "🇰🇷", "desc": "국내 주식 전문 — 코스피·코스닥의 패왕"},
        2: {"name": "서학파", "emoji": "✈️",  "desc": "해외 주식 전문 — 나스닥·NYSE를 누비는 자"},
        3: {"name": "퀀트파", "emoji": "🤖",  "desc": "데이터·알고리즘 투자 — 숫자로 시장을 지배"},
    }
    ...
    CLASS_TITLES = {
        1: {  # 국장파 ─────────────────────────────
            10: [("국장 전사",      "⚔️"),  ("코스피 사냥꾼",  "📈"),  ("삼성전자 신봉자", "📱")],
            11: [("동학개미 전사",  "🛡️"), ("코스닥 정벌자",  "💹"),  ("국내주 공략자",   "🏹")],
            12: [("국장 전문가",    "🎓"),  ("KOSPI 분석가",   "📊"),  ("국내 대가",       "🏆")],
            13: [("동학개미 대장",  "🇰🇷"), ("국장 고수",      "💎"),  ("KOSPI 전략가",    "🧩")],
            14: [("국장 레전드",    "🌟"),  ("동학개미 정예",  "⚡"),  ("코스피 패왕",     "👊")],
            15: [("동학개미 마스터","🔥"),  ("국내주 신화",    "🏛️"), ("KOSPI 역사가",    "📖")],
            16: [("국장 초고수",    "💫"),  ("동학 그랜드마스터","🌈"),("코스피 전설",     "✨")],
            17: [("국장 신화",      "🔮"),  ("동학개미 신",    "🌠"),  ("KOSPI의 지배자",  "👑")],
            18: [("동학 역사를 쓰다","📜"), ("국장 초월자",    "🌌"),  ("코스피 최강자",   "🏅")],
            19: [("동학개미의 왕",  "🎯"),  ("국장 초월 존재", "⭐"),  ("코스피 신의 경지","🌸")],
        },
        2: {  # 서학파 ─────────────────────────────
            10: [("나스닥 사냥꾼",  "📡"),  ("월가 침투자",    "💵"),  ("테슬라 신봉자",   "🚗")],
            11: [("서학개미 전사",  "✈️"),  ("해외주 공략자",  "🗺️"), ("엔비디아 신봉자", "🖥️")],
            12: [("해외주 전문가",  "🎓"),  ("S&P500 분석가",  "📊"),  ("나스닥 대가",     "🏆")],
            13: [("서학개미 대장",  "🌎"),  ("해외주 고수",    "💎"),  ("NYSE 전략가",     "🧩")],
            14: [("서학 레전드",    "🌟"),  ("서학개미 정예",  "⚡"),  ("나스닥 패왕",     "🦅")],
            15: [("서학개미 마스터","🔥"),  ("해외주 신화",    "🏛️"), ("월가 역사가",     "📖")],
            16: [("서학 초고수",    "💫"),  ("서학 그랜드마스터","🌈"),("나스닥 전설",     "✨")],
            17: [("서학 신화",      "🔮"),  ("서학개미 신",    "🌠"),  ("NYSE의 지배자",   "🏹")],
            18: [("서학 역사를 쓰다","📜"), ("서학 초월자",    "🌌"),  ("나스닥 최강자",   "🏅")],
            19: [("서학개미의 왕",  "🎯"),  ("서학 초월 존재", "⭐"),  ("나스닥 신의 경지","🌺")],
        },
        3: {  # 퀀트파 ─────────────────────────────
            10: [("퀀트 견습생",    "🤖"),  ("데이터 마이너",  "🧮"),  ("알고리즘 탐험가", "🧭")],
            11: [("팩터 개미",      "⚗️"),  ("시스템 지망생",  "⚙️"),  ("코드 개미",       "💻")],
            12: [("퀀트 전문가",    "🎓"),  ("알파 탐색자",    "🧩"),  ("리스크 계산자",   "⚖️")],
            13: [("퀀트 개미",      "🔬"),  ("시스템 트레이더","⚙️"),  ("AI 투자자",       "🤖")],
            14: [("퀀트 레전드",    "🌟"),  ("퀀트 전략가",    "⚡"),  ("모델 마스터",     "🔢")],
            15: [("퀀트 마스터",    "💎"),  ("알파 생성자",    "✨"),  ("시스템 신화",     "🏛️")],
            16: [("퀀트 초고수",    "💫"),  ("퀀트 그랜드마스터","🌈"),("알고리즘 전설",   "⭐")],
            17: [("퀀트 신화",      "🔮"),  ("퀀트개미 신",    "🌠"),  ("데이터의 지배자", "📊")],
            18: [("퀀트 역사를 쓰다","📜"), ("퀀트 초월자",    "🌌"),  ("알파 최강자",     "🏅")],
            19: [("퀀트개미의 왕",  "🎯"),  ("퀀트 초월 존재", "⭐"),  ("알고리즘 신의 경지","🌻")],
        },
    }
...
/각성 (/ㄱㅎ) — 골드를 써서 레벨업 도전! (실패 시 Lv.0 초기화)
  └ Lv.10 달성 시 국장파·서학파·퀀트파 중 직군 자동 배정!
  └ 직군 배정 후엔 해당 직군 전용 칭호 트리로 성장
/능력 — 현재 각성 레벨·직군·칭호·보너스 확인
/시장예측 [금액] — 과거 주가 예언 배틀 (맞추면 2배!)
/업다운 [금액] — 숫자 연속 맞추기, 연승할수록 배율 UP

⚔️ 소셜
/배틀 [종목] [상승/하락] [금액] — 다른 개미와 1:1 주가 예측 대결
/배틀목록 — 현재 대기 중인 배틀 목록
/미션 — 오늘의 거래 미션 + 보상 확인
/업적 — 달성한 업적 모아보기
/챌린지 — 주간 수익률 챌린지
