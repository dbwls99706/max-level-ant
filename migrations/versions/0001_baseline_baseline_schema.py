...
def downgrade() -> None:
    ...
    with op.batch_alter_table("user_challenges", schema=None) as batch_op:
        batch_op.drop_index(batch_op.f("ix_user_challenges_kakao_id"))
        batch_op.drop_index(batch_op.f("ix_user_challenges_challenge_id"))

    op.drop_table("user_challenges")
    with op.batch_alter_table("transactions", schema=None) as batch_op:
        batch_op.drop_index(batch_op.f("ix_transactions_kakao_id"))
        batch_op.drop_index("ix_transaction_user_created")

    op.drop_table("transactions")
    with op.batch_alter_table("milestones", schema=None) as batch_op:
        batch_op.drop_index(batch_op.f("ix_milestones_kakao_id"))

    op.drop_table("milestones")
    with op.batch_alter_table("holdings", schema=None) as batch_op:
        batch_op.drop_index(batch_op.f("ix_holdings_kakao_id"))
        batch_op.drop_index("ix_holding_user_stock")

    op.drop_table("holdings")
    with op.batch_alter_table("chatroom_members", schema=None) as batch_op:
        batch_op.drop_index(batch_op.f("ix_chatroom_members_kakao_id"))
        batch_op.drop_index(batch_op.f("ix_chatroom_members_group_key"))
        batch_op.drop_index("ix_chatroom_group_kakao")

    op.drop_table("chatroom_members")
    with op.batch_alter_table("battles", schema=None) as batch_op:
        batch_op.drop_index(batch_op.f("ix_battles_status"))
        batch_op.drop_index(batch_op.f("ix_battles_opponent_id"))
        batch_op.drop_index(batch_op.f("ix_battles_challenger_id"))

    op.drop_table("battles")
    with op.batch_alter_table("asset_history", schema=None) as batch_op:
        batch_op.drop_index(batch_op.f("ix_asset_history_kakao_id"))
